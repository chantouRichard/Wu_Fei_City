  ...
  <view class="container">
    ...
    <view class="feature-cards">
      ...
      <view class="card card-ai" @click="goToChatPage">
        ...
        <image
          src="/static/index/无废AI助手.png"
          class="card-image ai-image"
          mode="aspectFit"
        ></image>
      </view>
    </view>
    ...
    <view class="knowledge-section">
      ...
      <scroll-view class="tags-scroll" scroll-x="true" show-scrollbar="false">
        <view class="tags-pages">
          <view
            class="tags-page"
            v-for="(page, pageIdx) in tagPages"
            :key="pageIdx"
          >
          ...
          <view class="activity-participants">
            <view class="avatars-stack">
              <image
                ...
                :key="index"
                :src="avatar.src"
                :style="{ zIndex: activity.avatars.length - index }"
              ></image>
            </view>
...
export default {
  ...
  methods: {
    ...
    goToKnowledgeDetail(tag) {
      uni.navigateTo({
        url:
          "/pages/knowledge-detail/knowledge-detail?title=" +
          encodeURIComponent(tag.text),
      });
    },
    goToActivitiesPage() {
      if (this.userStore.userInfo.user_type == "normal")
        uni.navigateTo({
...
.header-section {
  ...
  background: linear-gradient(
    180deg,
    rgba(200, 255, 122, 0.7) 0%,
    rgba(205, 246, 148, 0) 100%
  );
  display: flex;
  align-items: center;
  padding: 0 24px;
...
.card-bank {
  background: linear-gradient(
    131.85deg,
    rgba(252, 208, 187, 1) 0%,
    rgba(252, 208, 187, 0.17) 100%
  );
}
...
.card-ai {
  background: linear-gradient(
    131.67deg,
    rgba(195, 235, 138, 1) 0%,
    rgba(245, 255, 232, 1) 100%
  );
}
