          ...
          <view class="activity-card">
            <view class="activity-header">
              ...
              <view class="activity-info">
                ...
                <view class="activity-phone">联系电话：{{ item.phone || '1271...' }}</view>
              </view>
            </view>
            
            <!-- 审核按钮 -->
            <view class="review-actions">
              <button class="reject-btn" @click="handleReject(item.id)">不通过</button>
            ...
            <view class="activity-header">
              ...
              <view class="activity-info">
                ...
                <view class="activity-bottom">
                  <view class="activity-responsible">负责人：{{ item.responsible || '张*君' }}</view>
