<template>
  <view class="login-container">
    ...
    <view class="background-area" :class="backgroundStyle">
      <image class="background-image" src="/static/login/background.png" mode="aspectFill" />
...
.background-area {
  ...
  width: 100%;
  height: 100vh;
  /* 缩小为原来的三分之二：66.67vh * 2/3 = 44.44vh */
  overflow: hidden;
  box-sizing: border-box;
}
...
.input-group {
  ...
  /* 减少底部内边距，让边框离文本更近 */
  border-bottom: 0.3vh solid #999999;
  /* 边框高度相对屏幕固定 */
